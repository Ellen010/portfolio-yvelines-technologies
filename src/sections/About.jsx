                    ...
                    <div className="grid-container">
                        ...
                        <div>
                            ...
                            <p className="grid-subtext">
                                With over 2 years of experience, I have sharpened my skills in both frontend and backend dev, creating dynamic
                    ...
                    <div className="grid-container">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="copy-container" onClick={handleCopy}>
                                ...
                                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">ewlen04@outlook.com</p>
                            </div>
                        </div>
                    </div>
                </div>
