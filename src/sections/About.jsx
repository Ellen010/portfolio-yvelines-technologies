...
const About = () => {
    ...
    useGSAP(() => {
        gsap.fromTo(`.animatedText`, { opacity: 0, y: 50 }, { opacity: 1, duration: 1, stagger: 0.5, ease: 'power2.inOut' });
    }, []);
                ...
                <div className="col-span-1 xl:row-span-3">
                    <div className="grid-container">
                        ...
                        <div id="project-desc" >
                            ...
                            <p className="animatedText">My approach is always centered on the client’s goals.
                            ...
                            <p className="animatedText">Client satisfaction is my top priority. I aim to make our collaboration smooth,
                    ...
                    <div className="project-desc">
                        <p className="animatedText">Tech Stack</p>
                            <p className="animatedText">
                                ...
                                <p className="animatedText">
                                    <span className="text-white-500">Frontend Development: </span>
                                ...
                                <p className="animatedText">
                                <span className="text-white-500">Backend Development: </span>
                                ...
                                <p className="animatedText">
                                <span className="text-white-500">Tools & Methodologies: </span>
                                ...
                                <p className="animatedText">
                                <span className="text-white-500">Soft Skills: </span>
            ...
            <div className="col-span-1 xl:row-span-4">
                ...
                <div className="xl:col-span-2 xl:row-span-3">
                    <div className="grid-container">
                        ...
                        <div>
                            <p className="animatedText">My Passion for Coding</p>
                            <p className="animatedText">
